...
export class ProfileComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (loggedUser.country !== undefined) {
      this.country = loggedUser.country.code;
      this.SelectedCountry = loggedUser.country.country;
    }
    ...
    this.profileForm.get('Birthplace').setValue(loggedUser.birthPlace);
  ...
  confirmProfile() {
    ...
    this.profileData.birthDate = this.profileForm.get('Birthday').value;
    this.profileData.birthDate = this.profileForm.get('Birthday').value;
