...
import { MediaService } from '../../_service/media/media.service';


@Component({
  selector: 'app-media-autocomplete',
  templateUrl: './media-autocomplete.component.html',
  styleUrls: ['./media-autocomplete.component.scss']
})
export class MediaAutocompleteComponent implements OnInit, OnChanges {
  ...
  getTeams(data: any) {
    ...
    return this.mediaService.getMedias(data)
      .pipe(map(option => {
        return option || []
      }));
  }
